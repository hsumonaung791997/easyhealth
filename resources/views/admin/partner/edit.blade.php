...
@section('content')
    ...
    <div class="content">
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    {!! Form::model($partner, ['route' => ['partner.update', $partner->id], 'method' => 'patch', 'files' => 'true']) !!}
    ...
    <script>
        $(function () {
            ...
            var initPreview = "<?php echo null != $partner->media ? url($partner->media->file_path . $partner->media->file_name) : url('images/default_preview.png') ?>";
            var initPreviewAlt = "<?php echo null != $partner->media ? $partner->media->file_caption : '' ?>";
            var dataId = "<?php echo null != $partner->media ? $partner->media->id : '' ?>";
            var dataUrl = "<?php echo null != $partner->media ? url('admin/media/' . $partner->media->id) : '' ?>";
