...
@section('content')
            ...
            <div class="box-body">
                <div class="row">
                    {!! Form::model($team, ['route' => ['team.update', $team->id], 'method' => 'patch', 'files' => 'true']) !!}
                        ...
                        <div class="form-group col-sm-6 mmtext">
                            {!! Form::label('file', 'Upload Team Photo :') !!}
    ...
    <script>
        $(function () {
            ...
            var initPreview = "<?php echo null != $team->media ? url($team->media->file_path . $team->media->file_name) : url('images/default_preview.png') ?>";
            var initPreviewAlt = "<?php echo null != $team->media ? $team->media->file_caption : '' ?>";
            var dataId = "<?php echo null != $team->media ? $team->media->id : '' ?>";
            var dataUrl = "<?php echo null != $team->media ? url('admin/media/' . $team->media->id) : '' ?>";
